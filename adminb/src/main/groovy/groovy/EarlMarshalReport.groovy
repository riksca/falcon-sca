    ...
    body {
        div (class: "dataBox") {
            table {
                ...
                tr {
                    td(class: "${row%2 == 0 ? 'row_even': 'row_odd'}", "Number of Active fighters with WSH Authorization")
                    td(class: "${row%2 == 0 ? 'row_even': 'row_odd'}", wshCount)
                    row++
                }
                tr {
